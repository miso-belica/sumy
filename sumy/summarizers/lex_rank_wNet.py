...
class LexRankSummarizer(AbstractSummarizer):
    ...
    def _create_matrix(self, sentences, threshold, tf_metrics, idf_metrics):
        ...
        for row, (sentence1, tf1) in enumerate(zip(sentences, tf_metrics)):
            for col, (sentence2, tf2) in enumerate(zip(sentences, tf_metrics)):
                matrix[row, col] = self.compute_wordNet(sentence1, sentence2, tf1, tf2, idf_metrics)
        ...
        return matrix
    def _compute_wordNet(self, sentence1, sentence2, tf1, tf2, idf_metrics):
        #print (sentence1)
        #print (sentence2)
        ...
        for word1 in sentence1:
            ...
            for word2 in sentence2:
                ...
                if(len(word1synsets)>0 and len(word2synsets)>0):

                    #print (word1synsets[0].path_similarity(word2synsets[0]))
                    semsim = word1synsets[0].path_similarity(word2synsets[0])
        ...
        if(len(sentence1)==0 and len(sentence2)==0):
            return 0
        sim = sim/max(len(sentence1), len(sentence2))
        #print (sim)
        return sim
    ...
    def compute_wordNet(self, sentence1, sentence2, tf1, tf2, idf_metrics):
        #print (sentence1)
        #print (sentence2)
        ...
        for word1 in sentence1:
            ...
            for word2 in sentence2:
                ...
                if(len(word1synsets)>0 and len(word2synsets)>0):
                    ...
                    max_sim = 1
            sim+=max_sim
            #print( str(max_sim) + word1 + max_word)
